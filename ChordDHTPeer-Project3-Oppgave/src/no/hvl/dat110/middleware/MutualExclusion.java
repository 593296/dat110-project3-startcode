...
public class MutualExclusion {
	...
	public boolean doMutexRequest(Message message, byte[] updates) throws RemoteException {
		...
		// Task: start MutualExclusion algorithm
	...
	public void onMutexRequestReceived(Message message) throws RemoteException {
		...
		if (clock.getClock()== message.getClock()) {// condition????
		...
		// Task: write if statement to transition to the correct caseid
	...
	public void doDecisionAlgorithm(Message message, List<Message> queue, int condition) throws RemoteException {
		...
		/**
		 * case 0: Receiver is not accessing shared resource and does not want to (send
		 * OK to sender)
		 */
		case 0: {
		...
		/**
		 * case 1: Receiver already has access to the resource (dont reply but queue the
		 * request)
		 */
		case 1: {
			// queue this message
		...
		/**
		 * case 2: Receiver wants to access resource but is yet to (compare own message
